...
try:
    ...
    def machine_learning():
        ...
        lista_imprimir.append(
            f"Este proyecto fue desarrollado en Google Colab. Por esta razón, no\npuede contemplarlo en esta interfaz gráfica.")
        lista_imprimir.append(
            f"\nPodrás visualizar este proyecto a traves de este enlace:\nhttps://n9.cl/pxdwl")
    ...
    Data_1 = Proyectos("Creador de Nombres",
                       "Desarrolla un código en Python que pida a tu amigo responder dos preguntas con una sola palabra cada una, y luego combine esas palabras para crear una marca única.",
                       "#Python, #Input, #String", "19/03/2025", "Día 1", "1")

    Data_2 = Proyectos("Calculador de Comisiones",
                       "Trabajas en una empresa donde los vendedores reciben comisiones del 13%. Crea un programa que pida su nombre y cuánto han vendido este mes, y muestre la comisión total.",
                       "#Python, #Input, #Float, #Format", "20/03/2025", "Día 2", "2")

    Data_3 = Proyectos("Analizador de Textos",
                       "Solicita un texto y tres letras al usuario. El programa hará cinco análisis sobre el texto, usando las letras proporcionadas como base de comparación.",
                       "#Python, #String, #Input, #TextAnalysis", "22/03/2025", "Día 3", "3")

    Data_4 = Proyectos("Adivina el Número",
                       "El jugador debe adivinar un número entre 1 y 100 en un máximo de cinco intentos. El programa da pistas según el número ingresado en cada intento para ayudarlo.",
                       "#Python, #Random, #While, #Game", "27/03/2025", "Día 4", "4")

    Data_5 = Proyectos("El Ahorcado",
                       "El programa elige una palabra secreta y muestra guiones. El jugador intenta adivinar las letras. Si acierta, se revelan; si falla, pierde una vida. Gana al completar la palabra.",
                       "#Python, #Game, #Loops, #Conditions", "02/04/2025", "Día 5", "5")

    Data_6 = Proyectos("Recetario",
                       "El programa da la bienvenida, muestra cuántas recetas existen y en qué carpeta están. Luego permite elegir diferentes opciones para ver o gestionar recetas disponibles.",
                       "#Python, #Os, #Filesystem", "04/04/2025", "Día 6", "6")

    Data_7 = Proyectos("Cuenta Bancaria",
                       "Crea una clase Cliente con métodos para imprimir datos, depositar dinero y retirar fondos. Simula una cuenta bancaria con operaciones básicas de manejo de dinero.",
                       "#Python, #POO, #Métodos, #Clases", "10/04/2025", "Día 7", "7")

    Data_8 = Proyectos("Consola de Turnos",
                       "Simula un sistema de turnos para perfumería, farmacia y cosméticos. El cliente elige el área y recibe un turno como P-01, F-32, etc. Este proceso se repite para nuevos clientes.",
                       "#Python, #Condicionales, #Simulación, #Interacción", "13/04/2025", "Día 8", "8")

    Data_9 = Proyectos("Buscador de Números en Serie",
                       "Busca números de serie con formato específico en archivos .txt. Usa expresiones regulares para recorrer carpetas, muestra los hallazgos en consola y calcula el tiempo total de búsqueda.",
                       "#Python, #Regex, #Os, #Datetime, #Automatización", "14/02/2025", "Día 9", "9")

    Data_10 = Proyectos("Invasión Espacial",
                        "Juego estilo Space Invaders con Pygame. Controla una nave, dispara a enemigos, evita que lleguen al fondo. Incluye efectos de sonido y un sistema de puntaje con retroalimentación.",
                        "#Python, #Pygame, #Juego2D, #Animaciones, #Colisiones", "17/04/2025", "Día 10", "10")

    Data_11 = Proyectos("Scraping de Libros",
                        "Realiza scraping de 'Books to Scrape' con requests y BeautifulSoup. Extrae títulos de libros con 4 o 5 estrellas, recorriendo las 50 páginas del sitio y mostrando los resultados.",
                        "#Python, #WebScraping, #BeautifulSoup, #Requests", "21/04/2025", "Día 11", "11")

    Data_12 = Proyectos("Gestor de Restaurantes",
                        "Sistema de facturación con interfaz gráfica (Tkinter). Permite seleccionar productos, calcular totales e impuestos, guardar recibos y usar una calculadora integrada para las operaciones.",
                        "#Python, #Tkinter, #InterfazGráfica, #Facturación, #GUI", "22/04/2025", "Día 12", "12")

    Data_13 = Proyectos("Asistente Personal",
                        "Asistente virtual por voz que entiende comandos y responde con voz. Puede decir la hora, abrir páginas, buscar en Wikipedia, y realizar varias tareas usando librerías como pyttsx3 y speech_recognition.",
                        "#Python, #AsistenteVirtual, #ReconocimientoVoz, #pyttsx3, #speechrecognition", "02/05/2025",
                        "Día 13", "13")

    Data_14 = Proyectos("Reconocimiento Facial",
                        "Captura imágenes con la webcam, compara rostros con una base de empleados y registra nombre y hora si hay coincidencia. Usa OpenCV y face_recognition para la identificación precisa.",
                        "#Python, #ReconocimientoFacial, #OpenCV, #face_recognition", "02/05/2025", "Día 14", "14")

    Data_15 = Proyectos("Machine Learning - Titanic",
                        "Analiza el dataset del Titanic usando árboles de decisión. Predice la supervivencia según variables como sexo, edad y clase. Incluye limpieza de datos, métricas, visualización y análisis.",
                        "#Python, #MachineLearning, #ÁrbolDeDecisión, #Titanic, #ScikitLearn", "03/05/2025", "Día 15",
                        "15")

    Data_16 = Proyectos("Aplicación Web de Tareas",
                        "Desarrolla una app web para gestionar tareas personales con Django. Incluye login, CRUD, filtro de tareas y contador. El diseño usa HTML y CSS, asegurando que cada usuario solo vea sus tareas.",
    ...
    def boton():
        ...
        if selecciones:
            ...
            if Data_1.titulo in nombre:
                ...
                borrar_panel_derecho()
                descripciones(Data_10.dia, Data_10.fecha, Data_10.titulo, Data_10.descripcion, Data_10.etiqueta, juego())

            elif Data_11.titulo in nombre:
                borrar_panel_derecho()
                descripciones(Data_11.dia, Data_11.fecha, Data_11.titulo, Data_11.descripcion, Data_11.etiqueta, web_scraping())

            elif Data_12.titulo in nombre:
                borrar_panel_derecho()
                descripciones(Data_12.dia, Data_12.fecha, Data_12.titulo, Data_12.descripcion, Data_12.etiqueta, "Este proyecto se ejecuta en una pestaña diferente.")
                time.sleep(5)
                mi_restaurante()

            elif Data_13.titulo in nombre:
                borrar_panel_derecho()
                descripciones(Data_13.dia, Data_13.fecha, Data_13.titulo, Data_13.descripcion, Data_13.etiqueta, "Este proyecto se ejecuta usando su microfono obligatoriamente.\n\nPara el correcto funcionamiento de este proyecto, tiene que hablar\nrapidamente cuando el asistenete este callado para que pueda\nreconocer la acción deseada.")
                time.sleep(10)
                asistente_personal()

            elif Data_14.titulo in nombre:
                borrar_panel_derecho()
                descripciones(Data_14.dia, Data_14.fecha, Data_14.titulo, Data_14.descripcion, Data_14.etiqueta, "Este proyecto se ejecuta usando una webcam obligatoriamente.\n\nPor este motivo, si no consigue ver nada en esta terminal después de\nun tiempo. La razón es que no el programa ha conseguido detectar\ncorrectamente su webcam.")
                time.sleep(3)
                reconocimiento_facial()

            elif Data_15.titulo in nombre:
                borrar_panel_derecho()
                descripciones(Data_15.dia, Data_15.fecha, Data_15.titulo, Data_15.descripcion, Data_15.etiqueta, machine_learning())

            elif Data_16.titulo in nombre:
                borrar_panel_derecho()
                descripciones(Data_16.dia, Data_16.fecha, Data_16.titulo, Data_16.descripcion, Data_16.etiqueta, 'Este proyecto fue desarrollado junto a "Django". Por esta razón, no\npuedes contemplarlo en esta interfaz gráfica.\n\nPodrás visualizar este proyecto a traves de esta url local:\nhttp://localhost:8000/')
                #time.sleep(60)
                #pagina_web()
