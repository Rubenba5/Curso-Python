...
def Nombre_Cerveza():
    try:
        ...
        # Lista de series
        series_lista = ["La Casa de Papel", "El Ministerio del Tiempo", "Cuéntame cómo pasó", "Los Serrano", "Aquí no hay quien viva", "Aída", "El Internado"]
    ...
    try:
        ...
        def letra_en_palabra(palabra, letra_importada, lista, Vidas, lista_fallos, lista_acietos):
                ...
                if letra_importada in palabra and letra_importada not in lista_acietos:
                    ...
                    lista_imprimir.append(f"Las letras ({lista_a_ensenar}) no están en la palabra. Te quedan {Vidas} intentos.")
                return Vidas
...
def recetario():
    try:
        ...
        def menu_despligue():
            ...
            lista_imprimar.append("[1] Leer receta\n[2] Crear Receta\n[3] Crear Categoria\n[4] Eliminar Receta\n[5] Eliminar Categoria\n[6] Finalizar Programa")
