...
while Bucle:
    try:
        ...
        if Respuesta == Data_1.dia or Respuesta == Data_1.titulo or Respuesta == Data_1.numero:
            ...
            print("")
            print(f"Podrás visualizar este proyecto a traves de {negrita("este enlace")}: {negrita_y_subrayado("https://github.com/Rubenba5/Curso-Python/blob/main/Dia%2015/Machine%20Learning/Python%20TOTAL%20-%20Machine%20Learning.ipynb")}.")
